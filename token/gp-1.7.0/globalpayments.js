(function (global, factory) {
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(unfetch_es);
	...
	*/
	...
	var Promise$2 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), lib, {
		'default': lib
	}));

	window.Promise = window.Promise || Promise$2;
	...
	***************************************************************************** */
	...
	var urls$3 = {
	    tokenization: function (prod) {
	        return prod
	            ? domains$3.production + "/SecureSubmit.v1/api/token"
	            : domains$3.sandbox + "/Hps.Exchange.PosGateway.Hpf.v1/api/token";
	    },
	};
	var actions$3 = {
	...
	var requiredSettings$3 = ["publicApiKey"];
	...
	var urls$4 = {
	    ...
	    tokenization: function (prod) {
	        return domains$4[getEnv$4()] + "/tokenization/temporary_tokens";
	    },
	};
	var actions$4 = {
	...
	var requiredSettings$4 = ["X-GP-Api-Key", "X-GP-Environment"];
	...
	var actionTokenize$5 = (function (url, enbv, data) {
	...
	var urls$5 = {
	    tokenization: function (prod) {
	        options.tsepHost = prod ? domains$5.production : domains$5.sandbox;
	...
	var requiredSettings$5 = ["deviceId", "manifest"];
